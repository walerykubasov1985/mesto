export class Card {
  constructor({ data, userId, templateElement, handleCardClick, handleDeleteIconClick, handleAddLike, handleDeleteLike }) {
  ...
  _setEventListeners() {
    ...
    this._imageBtnDelete.addEventListener('click', () => { this._handleDeleteIconClick(this._cardId) });
